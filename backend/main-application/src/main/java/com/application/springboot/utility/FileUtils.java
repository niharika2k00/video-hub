...
public class FileUtils {
  ...
  public String handleImageUpload(int userId, MultipartFile file) throws Exception {
    ...
    System.out.println("📋 Total number of S3 buckets present: " + s3Client.listBuckets().buckets().size());
    // s3Client.listBuckets().buckets().forEach(b -> System.out.println("📦 Bucket name: " + b.name()));
  ...
  public void deleteFileByUrl(String url) {
    ...
    // example: "https://<bucket_name>.s3.amazonaws.com/profile_images/1.png"
